...
.LM11:
	leaq	edata(%rip), %rdi
	leaq	end(%rip), %rdx
	.stabn	68,0,25,.LM12-.LFBB2
.LM12:
	subq	$8, %rsp
	.cfi_def_cfa_offset 16
	.stabn	68,0,31,.LM13-.LFBB2
.LM13:
	xorl	%esi, %esi
	subq	%rdi, %rdx
	call	memset@PLT
	.stabn	68,0,35,.LM14-.LFBB2
.LM14:
	call	cons_init@PLT
...
.LM20:
	...
	.p2align 3
.L13:
	.stabn	68,0,79,.LM21-.LFBB3
.LM21:
	xorl	%edi, %edi
	call	monitor@PLT
	jmp	.L13
.L16:
	.stabn	68,0,65,.LM22-.LFBB3
.LM22:
	movq	%rbx, panicstr(%rip)
	.stabn	68,0,68,.LM23-.LFBB3
.LM23:
#APP
# 68 "kern/init.c" 1
	cli; cld
...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L18:
	.stabn	68,0,85,.LM31-.LFBB4
.LM31:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,88,.LM32-.LFBB4
.LM32:
	leaq	224(%rsp), %rax
